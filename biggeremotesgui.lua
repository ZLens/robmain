...
BackFrame.Size = UDim2.new(1.2, 0, 0.9, 0.3)
...
SortButton.Position = UDim2.new(0.925, -5, -0.045, 0)
...
CloseButton.Position = UDim2.new(0.075, 0, -0.05, 0)
CloseButton.Size = UDim2.new(0.08, 0, 0.04, 0)
...
SearchBar.Position = UDim2.new(0.5, 0, -0.055, 0)
...
local function PlayEmote(name: string, id: IntValue)
    ...
    if LocalPlayer.Character.Humanoid.RigType ~= Enum.HumanoidRigType.R6 then
        ...
        SendNotification("You can't use R15 emotes as R6.")
    end
end
...
StarterGui:SetCore("SendNotification", {
    Title = "Notification";
    Text = "Bigger emotes made by DASHI3";
    Duration = 5;
})
